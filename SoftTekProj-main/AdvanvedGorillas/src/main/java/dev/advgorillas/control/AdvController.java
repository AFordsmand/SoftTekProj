package dev.advgorillas.control;

import dev.advgorillas.model.AdvModel;
import dev.advgorillas.model.entities.Banana;
...
public class AdvController {
    ...
    public AdvModel model;
    public AdvView view;
    public Stage stage;

    public AdvController(AdvModel model, AdvView view, Stage stage){
        this.model = model;
        this.view = view;
        this.stage = stage;
    ...
    public void setStartControls() {
        ...
        view.playButton.setOnAction(actionEvent -> {
            ...
            if (startCond) {
                ...
                view.setGameScene();
                model.drawGame(view.gc, model.player1Turn);
                setGameControls();
